...
class PedotransferFunctionsWosten():
    """
    This class calculates the Van Genuchten parameters from soil textural properties (Van Genuchten, 1980) using the
    Wösten pedotransfer function (Wösten et al., 1999). It requires the following input parameters:

    ================================================================================================================
    Symbol      Type    Definition                                                       Unit
    =======     =====   ================================================================ ===========================
    C           float   Clay weight percentage                                           cg clay g-1 soil
    D           float   Bulk density                                                     g soil cm-3 soil
    OM          float   Organic matter percentage                                        cg OM g-1 soil
    S           float   Silt percentage                                                  cg silt g-1 soil
    theta_r     float   Residual soil moisture content                                   cm3 water cm-3 soil
    topSoil     bool    Indicates whether the soil layer belong to the subsoil (True)
                        or not (False)                                                   -
    ================================================================================================================

    Python implementation is derived from an R version that can be found here:

    https://github.com/r-forge/soilwater/blob/master/pkg/soilwaterptf/R/ptf.wosten.R

    References:
    J.H.M Wösten, A Lilly, A Nemes, C Le Bas, Development and use of a database of hydraulic properties of
    European soils, Geoderma, Volume 90, Issues 3–4, 1999, Pages 169-185, ISSN 0016-7061,
    https://doi.org/10.1016/S0016-7061(98)00132-3
    """

    def __new__(cls, C, D, S, OM, theta_r, topSoil):
        instance = object.__new__(cls)
        dict_vg = instance.calculate_van_genuchten_parameters(C, D, S, OM, theta_r, topSoil)
        return dict_vg
